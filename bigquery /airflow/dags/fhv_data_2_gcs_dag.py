...
with DAG(
    ...
    gcs_2_gcs_task = move_files = GCSToGCSOperator(
        ...
        source_object="raw/fhv_tripdata*.csv",
    ...
    gcs_2_bq_ext_task = BigQueryCreateExternalTableOperator(
        ...
        table_resource={
            "tableReference": {
                ...
                "tableId": "external_fhv_trip_table",
            },
    ...
    CREATE_PART_TBL_QUERY = f"""CREATE OR REPLACE TABLE {BIGQUERY_DATASET}.fhv_tripdata_partitoned_clustered
        PARTITION BY DATE(dropoff_datetime)
        CLUSTER BY dispatching_base_num AS
        SELECT * FROM {BIGQUERY_DATASET}.external_fhv_trip_table"""
